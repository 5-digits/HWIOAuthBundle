        ...
        $rootNode
            ->children()
                ...
                ->arrayNode('templates')
                 ...
                 ->children()
                    ->scalarNode('login')
                        ->defaultValue('HWIOAuthBundle:Connect:login.html.twig')
                        ->cannotBeEmpty()
                    ->end()
                    ->scalarNode('registration')
                        ->defaultValue('HWIOAuthBundle:Connect:registration.html.twig')
                        ->cannotBeEmpty()
                    ->end()
                    ->scalarNode('registration_success')
                        ->defaultValue('HWIOAuthBundle:Connect:registration_success.html.twig')
                        ->cannotBeEmpty()
                    ->end()
                    ->scalarNode('connect_confirm')
                        ->defaultValue('HWIOAuthBundle:Connect:connect_confirm.html.twig')
                        ->cannotBeEmpty()
                    ->end()
                    ->scalarNode('connect_success')
                        ->defaultValue('HWIOAuthBundle:Connect:connect_success.html.twig')
                        ->cannotBeEmpty()
                    ->end()
                ->end()
            ->end()
